...
class MainUI:
    ...
    def __init__(self, title:str) -> None:
        ...
        conf_column = [
            [gui.Text("Console:")],
                [gui.Combo(values="", default_value="Select Port", size=self.LEFT_COLUMN_WIDTH-20, key=self.KEY_PORT_LIST),
            ...
            [gui.Listbox(values=[], enable_events=True, size=(self.LEFT_COLUMN_WIDTH, 20), background_color='#0a1016', key=self.KEY_MSG_LIST)],
        ]
